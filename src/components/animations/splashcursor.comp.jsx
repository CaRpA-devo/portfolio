  ...
  useEffect(() => {
    ...
    const containerEl =
      targetRef && targetRef.current
        ? targetRef.current
        : canvas.parentElement || window;

    function getRelativePosition(clientX, clientY) {
      const rect = (containerEl.getBoundingClientRect &&
        containerEl.getBoundingClientRect()) || { left: 0, top: 0 };
    ...
    const handleFirstMouseMove = (e) => {
      ...
      containerEl.removeEventListener("mousemove", handleFirstMouseMove);
    };
    ...
    const handleTouchStartOnce = (e) => {
      ...
      containerEl.removeEventListener("touchstart", handleTouchStartOnce);
    };
    ...
    if (containerEl && containerEl.addEventListener) {
      ...
      containerEl.addEventListener("mousemove", handleFirstMouseMove);
      containerEl.addEventListener("mousemove", handleMouseMove);
      containerEl.addEventListener("touchstart", handleTouchStartOnce);
      containerEl.addEventListener("touchstart", handleTouchStart);
      containerEl.addEventListener("touchmove", handleTouchMove, false);
      containerEl.addEventListener("touchend", handleTouchEnd);
    }
    // Ensure the canvas container has zIndex 0 so it doesn't overlay other elements
    if (canvas.parentElement) {
      canvas.parentElement.style.zIndex = "0";
    }
    updateFrame();
